...
<form name="add-user" action="/add-user" method="post">
	<!-- ############# name ################ -->
	<div class="row collapse">
	...
	<div class="row collapse">
		...
		<div class="row collapse">
			...
			<div class="small-10 columns">
				<label>
					<select id="street" disable>
						<option value="husker">Чкалова</option>
						<option value="starbuck">Светланская</option>
						<option value="hotdog">Чапаева</option>
						<option value="apollo">Адмирала Юмашева</option>
					</select>
				</label>
			</div>
		</div>
	...
	<div class="row collapse">
		...
		<div class="small-10 medium-11 columns">
			<input name="date" type="text" id="datetimepicker">
		</div>
	</div>
	<!-- ############ button ############### -->
	<div class="row">
